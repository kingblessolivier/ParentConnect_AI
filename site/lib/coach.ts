...
const DEMO_KB: Entry[] = [
  ...
  },
  {
    ...
    en: {
      kind: 'answer',
      answer:
        'Not knowing is normal, not a failure. Saying “I don’t know, let me find out” keeps your child’s trust; guessing loses it. If the topic feels awkward, naming that out loud can turn embarrassment into something honest: “this wasn’t discussed with me either, but I’d rather you heard it from me.”',
    ...
    rw: {
      kind: 'answer',
      answer:
        'Kutamenya ni ibisanzwe, ntabwo ari ikinyoma. Kuvuga ngo “simbizi, reka mbibaze” bigumana icyizere cy’umwana wawe; kwivugira ibitari byo bikibitakaza. Niba ikibazo gitera isoni, kubivuga uko biri bishobora guhindura isoni kuba ukuri: “na njye ntabwo nabimbwiwe, ariko nifuza ko unyumva.”',
...
const CONVO_GREETING: Record<Lang, CoachReply> = {
  en: {
    kind: 'answer',
    answer: 'Hello, I’m really glad you’re here. I’m your parenting coach, and you can ask me anything about talking with your child. We’ll take it one step at a time. What’s on your mind?',
  },
  rw: {
    kind: 'answer',
